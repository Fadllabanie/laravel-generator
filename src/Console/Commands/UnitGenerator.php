...
use fadllabanie\laravel_unittest_generator\Helpers\Generate\GenerateControllerHelper;
...
{
    protected $signature = 'generate:unittest {model} {modelPath} {--f|factory} {--c|controller} {--r|request}';
    ...
    public function handle()
    {
        ...
        if ($this->option('controller')) {
            $helper = new GenerateControllerHelper();
            $helper->generate($modelName, $modelClass);
        }
